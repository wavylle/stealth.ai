...
export default function SideNavBar() {
  ...
  return (
		<div className='fixed inset-y-0 left-0 z-10 flex-col border-r bg-background  w-[242px] min-w-[242px] h-screen sm:flex'>
			...
			<Separator
				...
				className='my-8 h-full stroke-1 bg-stroke-soft-200'></Separator>
		</div>
	);
}
