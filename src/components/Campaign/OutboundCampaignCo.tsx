...
export default function OutboundCampaignCo({
  CampaignName,
  CampaignDescription,
  CampaignType,
  StartedOn,
  ...
  AnsweredCalls,
  TotalCalls,
}: OutboundCampaignCoProps) {
  return (
    <div className=' min-w-[352px] min-h-[180px]  rounded-2xl bg-bg-white-0 box-border max-w-full overflow-hidden flex flex-col items-start justify-start py-3.5 pr-[11px] pl-[15px] gap-[8px] leading-[normal] tracking-[normal] text-left text-xs text-text-main-900 font-label-x-small border-[1px] border-solid border-stroke-soft-200'>
