...
export default function CampaignCo({  CampaignName , CampaignDescription, CampaignType , StartedOn, EndsOn, CompletedCalls, ScheduledCalls, AnsweredCalls, TotalCalls }: CampaignCoProps) {
    return <div
      className=" min-h-[180px]  rounded-2xl bg-bg-white-0 box-border max-w-full overflow-hidden flex flex-col items-start justify-start py-3.5 pr-[11px] pl-[15px] gap-[8px] leading-[normal] tracking-[normal] text-left text-xs text-text-main-900 font-label-x-small border-[1px] border-solid border-stroke-soft-200"
    >
      ...
      <div className="self-stretch h-4 flex flex-row items-start justify-start py-0 pr-[3px] pl-1 box-border gap-[12px] text-text-soft-400">
        <div className="flex-1 flex flex-row items-start justify-start gap-[11px]">
          <div className="relative leading-[16px] inline-block min-w-[55px]">Starts on:</div>
